...
abstract class Client extends ClientBase {
  core.String basePath = "/manager/v1beta2/projects/";
  ...
  DeploymentsResource_ get deployments => new DeploymentsResource_(this);
  TemplatesResource_ get templates => new TemplatesResource_(this);
